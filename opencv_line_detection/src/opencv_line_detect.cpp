...
#define ROI_CENTER_Y  768
#define ROI_WIDTH     256
...
public:
   ...
   void LaneDt(const sensor_msgs::Image::ConstPtr &img)
   {
      ...
      vector<Vec4i> linesP;
      HoughLinesP(mat_image_canny_edge, linesP, 1, CV_PI/180,20,260,20);
      ...
      */
      ...
      // imshow("mat_image_org_gray", mat_image_org_gray);
      // imshow("mat_image_roi", mat_image_roi);
      imshow("mat_image_canny_edge", mat_image_canny_edge);
...
{
   ros::init(argc, argv, "opencv_line_detection");
