...
const string state_table[11] = {"go","stop","big_obs","slow_down_for_traffic_light","static_obs","outbreak_obs","parking_search","parking_in","parking_wait","parking_out","finish"};
